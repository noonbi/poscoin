...
"""Verify that starting poscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start poscoin with -h for help text")
        ...
        self.log.info("Start poscoin with -version for version information")
        ...
        self.log.info("Start poscoind with -fakearg to make sure it does not start")
