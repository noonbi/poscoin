# Support for Output Descriptors in Poscoin Core

Since Poscoin Core v0.17, there is support for Output Descriptors. This is a
...
on Poscoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Poscoin Core wallets, a convenience function `combo` is
