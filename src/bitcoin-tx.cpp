...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " poscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  poscoin-tx [options] <hex-tx> [commands]  Update hex-encoded poscoin transaction\n" +
            "or:     poscoin-tx [options] -create [commands]   Create hex-encoded poscoin transaction\n" +
            "\n";
